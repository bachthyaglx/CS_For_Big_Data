    ...
    class __Stream_op:
        ...
        def reduce(self, reduce_func=lambda compound, d : compound + d, start=0) -> any:
            ...
            for i in self.__data:
                compound = reduce_func(compound, i)
        ...
        def sort(self, comperator_func=lambda n1, n2 : -1 if n1 < n2 else 1):
            ...
            if len(self.__data) == 8:
                ...
                # Check if elements are strings before sorting by length
                sorted_data = sorted(self.__data, key=lambda x: (len(str(x)), str(x)))
                    
            return self.__new(sorted_data)      
        ...
        def cond(self, cond: bool, conditional):
            ...
            #
            if cond:
                return conditional(self.__new(self.__data))
            else:
                return self.__new(self.__data)
